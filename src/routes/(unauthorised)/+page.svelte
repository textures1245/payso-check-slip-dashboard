...
<script lang="ts">
	...
	>
		...
		<div class="col-span-1 backdrop-blur-md w-full h-full py-20 lg:py-0 lg:px-0 md:px-20 sm:px-20 px-5 place-self-center">
			<Card.Root
				...
				<div class="container space-y-2">
					...
					<Card.Content>
						...
						<form id="loginbypayso" method="post" action="?/signInPayso">
							...
							<input type="text" name="username" placeholder="Username" id="uernameAdmin" style="width: 80%;height:40px" class="border border-spacing-10 px-5 rounded-2xl" />
							</div>
							<div class="flex justify-center">
							<input type="text" name="password" placeholder="Password" id="passwordAdmin" style="width: 80%;height:40px" class="my-3 border border-spacing-10 px-5 rounded-2xl"/>
							</div>
							<div class="flex justify-center">
								<Button type="submit" variant="outline" class="my-2 flex text-center py-0 px-0  bg-sky-400 rounded-2xl" style="width:80%;height:40px"  >Sign In</Button>
							</div>
						</form>
					</div>
					<hr class="my-5">
			  <div class="flex my-3 grid gap-1 grid-cols-3 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 sm:px-20 md:px-32 lg:px-0 px-10 text-white" style="width:100%;">
				<div class="flex justify-center"><Button variant="outline" class="my-2 flex text-center py-0 px-0  lg:bg-sky-400 md:bg-sky-400 sm:bg-sky-400 bg-sky-200 lg:rounded-md sm:rounded-md rounded-full" style="width:80%;height:40px" on:click={loginGoogle}><div class="lg:bg-sky-200 md:bg-sky-200 sm:bg-sky-200 flex rounded-sm w-20"  style="height:100%"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100%" height="100%" viewBox="0 0 48 48">
				  ...
				  </svg></div><div style="width: 100%;" class="content-center lg:block md:block sm:block hidden">Login With Google </div></Button></div>
				<div class="flex justify-center"><Button variant="outline" class="my-2 flex text-center py-0 px-0  lg:bg-blue-500 md:bg-blue-500 sm:bg-blue-500 lg:rounded-md sm:rounded-md bg-blue-700 rounded-full" on:click={facebook} style="width:80%;height:40px"><div class="lg:bg-blue-700 md:bg-blue-700 sm:bg-blue-700 rounded-sm w-20" style="height:100%"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100%" height="100%" viewBox="0 0 48 48">
				  <path fill="#039be5" d="M24 5A19 19 0 1 0 24 43A19 19 0 1 0 24 5Z"></path><path fill="#fff" d="M26.572,29.036h4.917l0.772-4.995h-5.69v-2.73c0-2.075,0.678-3.915,2.619-3.915h3.119v-4.359c-0.548-0.074-1.707-0.236-3.897-0.236c-4.573,0-7.254,2.415-7.254,7.917v3.323h-4.701v4.995h4.701v13.729C22.089,42.905,23.032,43,24,43c0.875,0,1.729-0.08,2.572-0.194V29.036z"></path>
				  </svg></div><div style="width: 100%;" class="content-center mx-2 lg:block md:block sm:block hidden"> Login With Facebook</div></Button></div>
				<div class="flex justify-center "><Button variant="outline" class="my-2 flex text-center py-0 px-0 lg:bg-green-500 md:bg-green-500 sm:bg-green-500 lg:rounded-md sm:rounded-md bg-green-800 rounded-full" on:click={line} style="width:80%;height:40px"><div class="lg:bg-green-800 md:bg-green-800 sm:bg-green-800  rounded-sm w-20" style="height:100%"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100%" height="100%" viewBox="0 0 48 48">
				  ...
				  </svg></div><div style="width: 100%;" class="content-center lg:block md:block sm:block hidden "> Login With Line</div></Button></div>
			  </div>
					</Card.Content>
