	...
	<div class=" flex justify-evenly ... text-xl font-sans ... h-60">
		...
		>
			<div class=" h-full max-h-70 content">
				...
				<div class=" w-100">
					<Button variant="outline" class="w-4/5 h-12 bg-orange-500">Dowload Excel</Button>
				</div>
			</div>
		</div>
		<div class="w-1/6 text-center">
		...
		{#each items as item}
			<div class="bg-slate-300 my-5 mx-5 rounded-xl">
				<div class="flex justify-around h-full">
					...
					<AlertDialog.Root>
						<AlertDialog.Trigger
							><Button variant="outline" class="bg-orange-500 w-full h-100">ดูรายการ</Button
							></AlertDialog.Trigger
						>
						<AlertDialog.Content
							class="bg-slate-300 rounded-lg p-4 h-full my-10 "
						...
						>
							<AlertDialog.Header>
								...
								<AlertDialog.Description>
									<div class="flex justify-around">
										<div class="content-center" style="width: 190px;">
							...
							<AlertDialog.Footer class="mt-4 flex justify-end space-x-2"></AlertDialog.Footer>
						</AlertDialog.Content>
					</AlertDialog.Root>
				</div>
			</div>
